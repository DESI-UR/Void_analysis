...
#
# This script runs VoidFinder on a mock catalog of DESI BGS.
################################################################################
...
#-------------------------------------------------------------------------------
# File header
survey_name = 'BGS_c000_ph000_' # worked for Dahlia
#survey_name = 'BGS_c000_ph000z_' # didn't work for Dahlia


# Change these directory paths to where your data is stored, and where you want 
# the output to be saved.
in_directory = '/global/homes/d/dveyrat/VAST1/example_scripts/'
out_directory = '../void_catalogs/DESI/BGS/mocks/'


# Input file name
# File format: RA, dec, redshift, comoving distance, absolute magnitude
galaxies_filename = 'BGS_c000_ph000.dat' # worked for Dahlia
#galaxies_filename = 'BGS_c000_ph000z.dat' # didn't work for Dahlia
#-------------------------------------------------------------------------------
