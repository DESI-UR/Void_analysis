...
This is based on the jupyter notebook Bayes_factors-g-r.ipynb, and needs to be 
run to produce the results visualized in Bayes_factors-g-r_void.ipynb.
'''
...
#-------------------------------------------------------------------------------
# Bin data
x, n1, n2, dn1, dn2 = bin_data(gr_NSA, 
                               gr_NSA[void_v2], 
                               gr_bins)
'''
#-------------------------------------------------------------------------------
...
# Pickle results
temp_outfile = open('pocoMC_results/sampler_results_M1_g-r_V2-void.pickle', 
                    'wb')
...
# 2-parent model
#-------------------------------------------------------------------------------
V2_fit_bounds2 = [[100, 25000],  # a1 ........ Gaussian A amplitude
...
# Pickle results
temp_outfile = open('pocoMC_results/sampler_results_M2_g-r_V2-void.pickle', 
                    'wb')
...
# Pickle results
temp_outfile = open('pocoMC_results/sampler_results_M1_g-r_VoidFinder-void.pickle', 
                    'wb')
...
# Pickle results
temp_outfile = open('pocoMC_results/sampler_results_M2_g-r_VoidFinder-void.pickle', 
                    'wb')
