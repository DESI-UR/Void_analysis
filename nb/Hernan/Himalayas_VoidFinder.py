...
#Keep survey_index equal to 4. The other survey setups are outdated 
survey_index=4
survey_name = ['desi_slice',
               'desi_slice_sdss_limmited',
               'sdss_slice',
               'desi_slice_2',
               'desi_full'][survey_index]
...
galaxies_filename = ['desi_hmslice.txt',
                     'desi_hmslice.txt',
                     'sdss_hmslice.fits',
                     'desi_hmslice_2.txt',
                     'himalayas_masked.txt'][survey_index]
#-------------------------------------------------------------------------------
...
min_z = 0
max_z =[0.228,0.114,0.114,.228,.228][survey_index]
