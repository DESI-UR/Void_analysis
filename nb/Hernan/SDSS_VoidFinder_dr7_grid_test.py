...
#-------------------------------------------------------------------------------
# File header
#The survey index determies which combiation of cell seeding and grid shifting is used
survey_index = 3
survey_name = ['0_empty_cells_grid_origin',
               '1_empty_cells_grid_shifted',
               '2_all_cells_grid_origin',
               '3_all_cells_grid_shifted'][survey_index]
...
#The below file is provide in the VAST example scripts. The path should be set acccordingly when the
#code is rerun
...
dx=1.1
coords_min = [
    np.array([-301.18334355, -274.34853238,  -18.42489094]),
    np.array([-301.18334355, -274.34853238,  -18.42489094])-dx,
    np.array([-301.18334355, -274.34853238,  -18.42489094]),
    np.array([-301.18334355, -274.34853238,  -18.42489094])-dx
][survey_index]

check_all_cells = [False, False, True, True][survey_index]
...
find_voids(wall_coords_xyz, 
           ...
           dist_limits=dist_limits,
           check_only_empty_cells = not check_all_cells,
